...
function [M,L,eps] = SIM_logMargL_Opt(x,N,maxM,Par,ParS)
    ...
    % Basal conditions:
        ...
        L.t00 = DATA_logMargL(M.t00,x.t00);
    ...
    % Stimulus conditions:
        ...
        for t = 2:length(myT)
            ...
            % Calculate the log-likelihood:
            L.(myT{t}) = DATA_logMargL(M.(myT{t}),x.(myT{t}));
    ...
    clear pS p myT t tt A P temp expAtStep
